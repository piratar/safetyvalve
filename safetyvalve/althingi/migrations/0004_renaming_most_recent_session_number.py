...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column(u'althingi_parliamentarian', 'most_recent_session_number', 'most_recent_session_served')


        # Changing field 'Parliamentarian.party'
        db.alter_column(u'althingi_parliamentarian', 'party', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):
        # Adding field 'Parliamentarian.most_recent_session_number'
        db.rename_column(u'althingi_parliamentarian', 'most_recent_session_served', 'most_recent_session_number')


        # Changing field 'Parliamentarian.party'
        db.alter_column(u'althingi_parliamentarian', 'party', self.gf('django.db.models.fields.CharField')(max_length=100))
