...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IssueVotingRound.issue'
        db.add_column(u'althingi_issuevotinground', 'issue',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['althingi.Issue'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IssueVotingRound.issue'
        db.delete_column(u'althingi_issuevotinground', 'issue_id')
    ...
    models = {
        ...
        u'althingi.issuevotinground': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['althingi.Issue']", 'null': 'True'}),
