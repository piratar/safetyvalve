...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IssueVotingRound.issue'
        db.alter_column(u'althingi_issuevotinground', 'issue_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['althingi.Issue']))

    def backwards(self, orm):

        # Changing field 'IssueVotingRound.issue'
        db.alter_column(u'althingi_issuevotinground', 'issue_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['althingi.Issue'], null=True))
